...
c[b]],!0)});return this});m("cells().deselect()","cell().deselect()",function(){var c=this;this.iterator("cell",function(a,b,c){b=a.aoData[b];b._selected_cells[c]=!1;b.anCells&&!a.aoColumns[c]._select_selected&&e(b.anCells[c]).removeClass(a._select.className)});this.iterator("table",function(a,b){k(c,"deselect",["cell",c[b]],!0)});return this});e.extend(g.ext.buttons,{selected:{text:o("selected","Selected"),className:"buttons-not_used",init:function(c){var a=this;c.on("draw.dt.DT select.dt.DT deselect.dt.DT",
function(){var b=a.rows({selected:!0}).any()||a.columns({selected:!0}).any()||a.cells({selected:!0}).any();a.enable(b)});this.disable()}},selectedSingle:{text:o("selectedSingle","Selected single"),className:"buttons-not_used-single",init:function(c){var a=this;c.on("draw.dt.DT select.dt.DT deselect.dt.DT",function(){var b=c.rows({selected:!0}).flatten().length+c.columns({selected:!0}).flatten().length+c.cells({selected:!0}).flatten().length;a.enable(1===b)});this.disable()}},selectAll:{text:o("selectAll",
